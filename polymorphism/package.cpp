...
public:
  ...
  double TotalCost() const { return weight_kg * price_per_kg; }
...
public:
  void AddPackage(StandardPackage *package) { Packages.push_back(package); }
  ...
  void SetCard(CreditCard *PaymentCard) { payment_card = PaymentCard; }
