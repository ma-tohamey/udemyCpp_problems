...
// High-level modules (wesite class) should not depend on low-level modules
// (PaypalPayment APIs). Both should depend on abstractions (e.g. IPayment).
...
public:
  ...
  virtual bool MakePayment(double money) {
    // This now similar to Adapter pattern. We change format of interface to
